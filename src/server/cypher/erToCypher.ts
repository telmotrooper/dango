...
import { generateStrictModeTrigger, generateMaxCardinality1Trigger, generateMinCardinality1Trigger, generateDisjointednessTrigger, generateCompletenessTrigger } from "./statements"
